...
namespace ITPM
{
    ...
    {
        MgtWorkingDays man = new MgtWorkingDays();
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    con.Open();
                    SqlCommand cmd = new SqlCommand("insert into workDH values('" + NoOfWorkingDays.Text + "','" + WorkingTimeMinutes1.Text + "','" + WorkingTimeHours1.Text + "')", con);
                    cmd.ExecuteNonQuery();
